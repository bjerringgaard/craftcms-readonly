...
class TableField extends Field
{
  ...
  {
    return Craft::t('app', 'Read only: Table');
  }
  ...
  public function getSettingsHtml(): ?string
  {
    ...
    $columnsField = $view->renderTemplate('readonly-fields/fieldtypes/table/columntable.twig', [
      'cols' => $columnSettings,
      'rows' => $this->columns,
    ...
    return $view->renderTemplate('readonly-fields/fieldtypes/table/settings.twig', [
      'field' => $this,
  ...
  private function _getInputHtml(mixed $value, ?ElementInterface $element, bool $static): string
  {
    ...
    return Craft::$app->getView()->renderTemplate('readonly-fields/fieldtypes/table/input.twig', [
      'id' => $this->getInputId(),
      'name' => $this->handle,
      'cols' => $this->columns,
      'rows' => $value,
