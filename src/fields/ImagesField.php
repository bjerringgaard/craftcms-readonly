...
class ImagesField extends Field implements PreviewableFieldInterface, SortableFieldInterface
{
  /**
   * @inheritdoc
   */
   ...
   */
  public ?string $columnType = Schema::TYPE_JSON;
  ...
  {
    return Craft::$app->getView()->renderTemplate('readonly-fields/fieldtypes/images/input.twig', [
      'name' => $this->handle,
      'value' => $value,
      'field' => $this,
      'placeholder' => null,
