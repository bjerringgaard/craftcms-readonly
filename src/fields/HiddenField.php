...
class HiddenField extends Field implements PreviewableFieldInterface, SortableFieldInterface
{
  /**
   * @inheritdoc
   */
  ...
  public function getSettingsHtml(): ?string
  {
    return Craft::$app->getView()->renderTemplate(
      'readonly-fields/fieldtypes/hidden/settings.twig',
      [
        'field' => $this,
      ]
    );
  ...
  {
    $namespaceInputId = Craft::$app->getView()->namespaceInputId($this->handle);

    return Craft::$app->getView()->renderTemplate('readonly-fields/fieldtypes/hidden/input.twig', [
      'id' => $namespaceInputId,
      'name' => $this->handle,
      'value' => $value,
      'field' => $this,
